...
public class PeriodReport extends JPanel {
	...
	public PeriodReport() {
		...
		textField_1.setBounds(162, 71, 77, 30);
		textField_1.setFont(new Font("Tahoma", Font.BOLD, 14));
		textField_1.setColumns(10);
		panelPeriod.add(textField_1);
		...
		textField_2.setBounds(191, 311, 85, 20);
		textField_2.setColumns(10);
		panelPeriod.add(textField_2);
		
		textField_3 = new JTextField();
		textField_3.setBounds(147, 283, 129, 20);
		...
		textField_8.setBounds(283, 160, 46, 14);
		textField_8.setColumns(10);
		panelPeriod.add(textField_8);
		
		textField_9 = new JTextField();
		textField_9.setBounds(283, 190, 46, 14);
		textField_9.setColumns(10);
		panelPeriod.add(textField_9);
		
		textField_10 = new JTextField();
		textField_10.setBounds(283, 215, 46, 14);
		textField_10.setColumns(10);
		panelPeriod.add(textField_10);
		
		textField_11 = new JTextField();
		textField_11.setBounds(283, 231, 46, 14);
		textField_11.setColumns(10);
		panelPeriod.add(textField_11);
		
		textField_12 = new JTextField();
		textField_12.setBounds(283, 246, 46, 14);
		textField_12.setColumns(10);
		panelPeriod.add(textField_12);
		
		textField_13 = new JTextField();
		textField_13.setBounds(283, 261, 46, 14);
