	...
	public void into()  {
		...
		button.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				back.setContentPane(back.FirstPanel);
		...
		tabbedPane.addTab("view referral", null, view_referral, null);
			view_referral.setLayout(null);
			
			JButton btnNewButton = new JButton("eyes\t - Dr. Levi                20/5/16                  eye test");

			btnNewButton.setBounds(0, 27, 448, 67);
				view_referral.add(btnNewButton);
			...
			btnCardiologyDrcohen.setBounds(0, 132, 448, 67);
			view_referral.add(btnCardiologyDrcohen);
			
			JButton btnOrthpedeDruziel = new JButton("Orthpede- Dr.Uziel              5/6/16                    urine test");
			btnOrthpedeDruziel.setBounds(0, 237, 448, 67);
			view_referral.add(btnOrthpedeDruziel);
		...
		JButton btnInsertResults = new JButton("insert results");
