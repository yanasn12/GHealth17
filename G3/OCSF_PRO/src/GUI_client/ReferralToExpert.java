...
public class ReferralToExpert extends JInternalFrame {

		private CreateNewExpertReferral newReferral;//// object of current
		private ViewExistingExpertReferral ExistingReferral;
	...
	private JPanel getFirstPanel(){
		...
		if(FirstPanel == null){
			...
			button.setIcon(new ImageIcon(ReferralToExpert.class.getResource("/javagui/resources/img16x16/nota.png")));
			...
			btnPartialFile.setIcon(new ImageIcon(ReferralToExpert.class.getResource("/javagui/resources/img16x16/nota.png")));
	...
	private void initComponent() {
		...
		this.newReferral = new CreateNewExpertReferral();
		...
		this.ExistingReferral = new ViewExistingExpertReferral();
