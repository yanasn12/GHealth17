...
CREATE TABLE `appointments` (
  ...
  KEY `appointment_as_referral_idx` (`referral_num`),
  KEY `patient_num_to_patients_idx` (`patient_num`),
  CONSTRAINT `appointment_as_referral` FOREIGN KEY (`referral_num`) REFERENCES `referrals` (`referral_num`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ...
  CONSTRAINT `patient_num_to_patients` FOREIGN KEY (`patient_num`) REFERENCES `patients` (`patient_num`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `appointments` VALUES (1,NULL,11,420,'arrived','2016-06-01',12,'2016-01-13','',1150),(2,NULL,11,425,'arrived','2016-06-01',17,'2016-04-16',NULL,1110),(3,NULL,22,424,'arived','2016-06-01',13,'2016-01-03',NULL,1100),(4,NULL,55,421,'arrived','2016-06-02',11,'2016-04-03',NULL,1180),(5,NULL,22,420,'arrived','2016-06-01',9,'2016-03-29',NULL,1130),(6,NULL,33,421,'arrived','2016-06-01',12,'2016-03-10',NULL,1170),(7,NULL,44,422,'not','2016-06-02',18,'2016-02-18',NULL,1190),(8,NULL,11,420,'arrived','2016-06-02',10,'2016-02-02',NULL,1140),(9,NULL,44,423,'arrived','2016-06-02',9,'2016-01-02',NULL,1160);
...
INSERT INTO `clinics` VALUES (11,'Clalit K. Binyamin','Kiryat Ata - Shprinzak 5','04-8478645','4'),(22,'Maccabi','Haifa - Haazmaut 52','04-8453677','4'),(33,'Clalit Ashkelon','Ashkelon - Vardinun 6','03-7167886','3'),(44,'Briut','Jerusalem - Borekasim 3','02-8677654','2'),(55,'Leumit','Sderot - Hasusim 30','03-6118787','3');
...
CREATE TABLE `daily_report` (
  ...
  `waiting_month_0` int(11) DEFAULT NULL,
  `waiting_month_1` int(11) DEFAULT NULL,
  `waiting_month_2` int(11) DEFAULT NULL,
  `waiting_month_3` int(11) DEFAULT NULL,
  `start_week_date` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`date`,`clinic_num`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `monthly_report` (
  ...
  `monthly_patient_amount` int(11) DEFAULT NULL,
  `monthly_patients_amount_avg` float DEFAULT NULL,
  `monthly_patients_amount_max` int(11) DEFAULT NULL,
  `monthly_patients_amount_min` int(11) DEFAULT NULL,
  `monthly_patients_amount_deviation` int(11) DEFAULT NULL,
  `left_patients_amount` int(11) DEFAULT NULL,
  `not_reached_amount` int(11) DEFAULT NULL,
  `waiting_month_0` int(11) DEFAULT NULL,
  `waiting_month_1` int(11) DEFAULT NULL,
  `waiting_month_2` int(11) DEFAULT NULL,
  `waiting_month_3` int(11) DEFAULT NULL,
  ...
  KEY `monthy_r_to_clinc_idx` (`monthly_patients_amount_avg`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `referrals` VALUES (1,NULL,11,1,'Leibovich Moisy','moisy@gmail.com',5,'Chest pain - Fainting',1),(2,NULL,11,1,'Rahamim Saadia','saadiram@gmail.com',5,'Peripheral edema - tiredness - Shortness of breath',8),(3,NULL,11,5,'Libin Leor','leorlib@gmail.com',2,'Lower abdominal pain - Burning urination',2),(4,NULL,22,1,'Dekel Elias','elias@gmail.com',5,'Fainting, tiredness -  Shortness of breath',5),(5,NULL,22,2,'Repoport Eran','eranrep@gmail.com',3,'back pain',3),(6,NULL,33,4,'Gragora Adi','gragora@gmail.com',4,'A discharge and ear',6),(7,NULL,44,3,'Faadel Hany','hanyfad@gmail.com',1,'Irregular menstrual cycles',7),(8,NULL,44,1,'Kera Tamra','kerat@gmail.com',5,'Heart palpitations - chest pain',9),(9,NULL,55,4,'Viar Galina','galiav@gmail.com',5,'A hearing problem - redness of the eardrum',4);
...
CREATE TABLE `report_file` (
  ...
  KEY `app_num_to_apps_idx` (`app_num`),
  CONSTRAINT `app_num_to_apps` FOREIGN KEY (`app_num`) REFERENCES `appointments` (`appointment_num`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
INSERT INTO `report_file` VALUES (1,1,NULL,1,'Heart description',1),(1,2,NULL,2,'Ortoped description',1),(2,3,NULL,2,'Ortoped description',0),(3,4,NULL,4,'ENT description',1),(4,5,NULL,5,'Urine description',1),(4,6,NULL,3,'Gani description',0);
...
CREATE TABLE `weekly_report` (
  ...
  `patients_amount` int(11) DEFAULT NULL,
  ...
  `Weekly_waiting_time_deviation` float DEFAULT NULL,
  `waiting_month_0` int(11) DEFAULT NULL,
  `waiting_month_1` int(11) DEFAULT NULL,
  `waiting_month_2` int(11) DEFAULT NULL,
  `waiting_month_3` int(11) DEFAULT NULL,
  `month_date` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`start_week_date`,`clinic_num`),
  KEY `weakly_r_for_clinc_idx` (`clinic_num`),
  KEY `month_date_idx` (`month_date`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2016-06-11 20:30:48
